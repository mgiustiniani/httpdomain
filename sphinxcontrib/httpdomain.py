...
RFC5789ANCHOR = 'section-'
RFCDRAFTLINK = 'http://tools.ietf.org/html/draft-snell-link-method-08'
RFCDRAFTLINKANCHOR = 'section-'
...
DOCREFS = {
    ...
    'link': DocRef(RFCDRAFTLINK, RFCDRAFTLINKANCHOR, 3),
    'unlink': DocRef(RFCDRAFTLINK, RFCDRAFTLINKANCHOR, 4),
...
class HTTPLink(HTTPResource):

    method = 'link'

class HTTPUnlink(HTTPResource):
...
class HTTPDomain(Domain):
    ...
    object_types = {
        ...
        'link': ObjType('link', 'link', 'obj'),
        'unlink': ObjType('unlink', 'unlink', 'obj')
    }
    ...
    roles = {
        ...
        'link': HTTPXRefRole('link'),
        'unlink': HTTPXRefRole('unlink'),
...
class HTTPLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            (r'(GET|POST|LINK|UNLINK|PUT|PATCH|DELETE|HEAD|OPTIONS|TRACE)( +)([^ ]+)( +)'
             r'(HTTPS?)(/)(1\.[01])(\r?\n|$)',
